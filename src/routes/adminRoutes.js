...
const { updateSeo, uploadIcon, uploadOgImage, uploadPromoBanner, uploadBitcoinQr } = require('../controllers/seoController')
...
router.post('/seo/upload-promo-banner/:index', upload.single('promoBanner'), uploadPromoBanner)
router.post('/seo/upload-bitcoin-qr', upload.single('bitcoinQr'), uploadBitcoinQr)
